          ...
          <form action="StudentAdd" method="post" class="px-4">
              ...
              <div class="mb-3">
                  ...
                  <select name="entYear" class="form-control">
                      ...
                      <c:forEach var="y" items="${ent_year_set}">
                          <option value="${y}" <c:if test="${student.entYear == y}">selected</c:if>>
                              ${y}
                          </option>
                      </c:forEach>
                  </select>
                  <div class="text-primary">${errors.get("entYear")}</div>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" name="no" class="form-control"
                         ...
                         value="${student.no}">
                  <div class="text-primary">${errors.get("no")}</div>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" name="name" class="form-control"
                         ...
                         value="${student.name}">
                  <div class="text-primary">${errors.get("name")}</div>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <select name="classNum" class="form-control">
                      <c:forEach var="c" items="${class_num_set}">
                          <option value="${c}" <c:if test="${student.classNum == c}">selected</c:if>>
                              ${c}
                          </option>
                      </c:forEach>
                  </select>
                  <div class="text-primary">${errors.get("classNum")}</div>
              </div>
