...
<c:import url="/common/base.jsp">
    ...
    <c:param name="content">
        ...
        <c:if test="${not empty selectedSubjectId && selectedSubjectId != '0'}">
            <p class="fw-bold">科目：${selectedSubjectName}（${selectedCount}回）</p>
        </c:if>
                    ...
                    <tbody>
                        <c:forEach var="t" items="${testList}">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="point_${t.student.no}" value="${t.point}" class="form-control" style="width:100px;">
